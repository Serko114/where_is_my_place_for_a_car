...
### Что будет, если применить детекцию на изображении с коэфф. < 0.58:

![parkovka](content_for_readme/2_online_resize.gif)

Как видно выше, при коэфф. меньше 0.58 детекция сильно путается, это связано с тем, что модель детекции была обучена на данных с почти полной парковкой, т.к. самое важное в данном репозитории это определить наличие пустых мест при почти полной парковке. В модель детекции пустая парковка не будет посялаться, а эта картинка сделана из любопытства))

### Примеры детектирования пустых мест при коэфф. > 0.58:

<!-- ![Пример](content_for_readme/1.2(online).gif) -->
![parkovka](content_for_readme/1.2_online_resize.gif)
![parkovka](content_for_readme/1.3_online_resize.gif)
![parkovka](content_for_readme/1.5_online_resize.gif)
